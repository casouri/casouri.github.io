...
In =index.org= of the index page, I have this snippet in the end of the file:
...
=ox-rss.el= exports each first-order header in the current file
...
The [[https://orgmode.org/manual/Macro-replacement.html][macro]][fn:2]:
