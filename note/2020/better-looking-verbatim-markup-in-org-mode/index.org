...
Sadly, there is no opportunity for hooks or advising the fontification function, I had to redefine ~org-do-emphasis-faces~. Towards the end of the function, we first change the ~pcase~ form to extra our extra entry added earlier, we change
