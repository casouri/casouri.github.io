...
Fast forward to a few days ago, I was reading a newsletter in my mail client, and noticed that the font looks so pretty! I’ve set the default font of my mail client to my font (so I can catch errors and tweak the font in a real setting), but it looked so good that I thought it’s using some other font that the newsletter brought itself. I had to zoom in and look at the letters back and forth before certain that it’s using my font. That encouraged me so much, and I thought I’ll do the “get a garbage out first” strat and just finish it real quick, not dwell on anything, and if I can’t make something work, I’ll just skip it.
...
I stole the skeleton from Jenson’s roman, but relaxed the aperture and shortened the x-height. I also maintained a low contrast, and kept a tiny bit of remnant of pen strokes, so the font captures that humane warmth but doesn’t appear too old. The curves are largely very simplistic, but I added a tiny bit of personality in the bowl of B, R, and D, and in the serif of G and S. So when you look up close, it’s not completely dull. ◊fnref["Qtail"]{R J Q t all have extended tails}, which I like; together with the wider capitals, they make the font spacious and extended and comfortable—some of the “workhorse” body text typefaces tends to have very short descenders and cramped tails and feet, which I sometimes find a bit undesirable. In this day and age, page count isn’t an issue anymore, so I say we deserve some more room.

◊fndef["Qtail"]{Q’s tail gives me a lot of trouble, I have to create a version with a shorter tail and replace it in when the long tail will collide with the glyph after. For example: QJ, Q, Qg. Fortunately it’s quite rare for Q to be followed by these kind of characters in English.}

Initially I created star-shaped periods, like Jenson’s roman had. But Kel talked me out of it. I kept it as a stylistic set for occasions that require som extra flair. I also started with a slightly slanted dash, but finally decided a flat one is more fitting for modern settings. (Also, flat dash makes better smiley faces :-)

Another guardrail—or limitation, depends on how you see it—that I set for myself is to make the counterspace as pretty as the strokes are. If you look at the inside of h, n, m, the triangles of x, v, y, w, the bowl of b, p, q, d, or inside and around the capitals, you’ll find them to be pretty shapes.
