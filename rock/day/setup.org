...
#+OPTIONS: toc:nil
#+MACRO: img [[../album/$1]]
#+MACRO: day_link (eval (format "#+HTML: <div id=\"day-link\"><a href=\"../day-%d/index.html\">Yesterday ☜</a><a href=\"../day-%d/index.html\">☞ Tommorrow</a></div>" (max 1 (1- (luna-blog-rock-this-day))) (1+ (luna-blog-rock-this-day))))
